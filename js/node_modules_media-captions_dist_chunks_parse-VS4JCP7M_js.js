"use strict";
(self["webpackChunktailpress"] = self["webpackChunktailpress"] || []).push([["node_modules_media-captions_dist_chunks_parse-VS4JCP7M_js"],{

/***/ "./node_modules/media-captions/dist/chunks/parse-VS4JCP7M.js":
/*!*******************************************************************!*\
  !*** ./node_modules/media-captions/dist/chunks/parse-VS4JCP7M.js ***!
  \*******************************************************************/
...
/* harmony export */ });
/* harmony import */ var _chunk_665KQXAY_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-665KQXAY.js */ "./node_modules/media-captions/dist/chunks/chunk-665KQXAY.js");
...
var SSAParser = class {
  ...
  async init(init) {
    this._init = init;
    if (init.errors)
      this._errorBuilder = (await __webpack_require__.e(/*! import() */ "node_modules_media-captions_dist_chunks_errors-VSYRGBIT_js").then(__webpack_require__.bind(__webpack_require__, /*! ./errors-VSYRGBIT.js */ "./node_modules/media-captions/dist/chunks/errors-VSYRGBIT.js"))).ParseErrorBuilder;
  }
  ...
  _parseDialogue(values, lineCount) {
    ...
    if (!timestamp)
      return;
    const cue = new _chunk_665KQXAY_js__WEBPACK_IMPORTED_MODULE_0__.VTTCue(timestamp[0], timestamp[1], ""), styles = { ...this._styles[fields.Style] || {} }, voice = fields.Name ? `<v ${fields.Name}>` : "";
  ...
  _parseTimestamp(startTimeText, endTimeText, lineCount) {
    const startTime = (0,_chunk_665KQXAY_js__WEBPACK_IMPORTED_MODULE_0__.parseVTTTimestamp)(startTimeText), endTime = (0,_chunk_665KQXAY_js__WEBPACK_IMPORTED_MODULE_0__.parseVTTTimestamp)(endTimeText);
